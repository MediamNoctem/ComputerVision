...
# 1
def f():
    img = cv2.imread("C:\\Users\\romAn\\Documents\\GitHub\\ComputerVision\\labs\\img\\hourse.jpg", 0)
    ...
    titles = ['Оригинал', 'Бинаризация Оцу',
...
# image_binarization("C:\\Users\\romAn\\Documents\\GitHub\\ComputerVision\\labs\\img\\hourse.jpg", 127)
